...
//Code Here
let evenNumbers= mixedNumbers.filter((element, index, wholeArray)=>{return element %2===0} ) 
...
// const myArrFiltered = myArr.filter(el => {
// 	return el % 2 === 0
// });

// console.log(myArrFiltered);
