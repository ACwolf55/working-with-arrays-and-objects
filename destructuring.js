...
return arizona+utah+texas+california;
...
let indg =[]
let {carb:arrCarb,fat:arrFat,protein:arrProtein} =obj
indg.push(arrCarb,arrFat,arrProtein)
return indg
...
if(third < first && third < second){return c}
